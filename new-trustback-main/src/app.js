...
// the resources routes
const ebookRoutes = require('./routes/resources/ebookRoutes.js');
const forumRoutes = require('./routes/resources/forumRoutes.js');
const mentorshipRoutes = require('./routes/resources/mentorshipRoutes.js');
const resourceTestimonialRoutes = require('./routes/resources/testimonialRoutes.js');
const videoLectureRoutes = require('./routes/resources/videoLectureRoutes.js');
const workshopRoutes = require('./routes/resources/workshopRoutes.js');
...
// lines for the resources API endpoints
app.use('/api/resources', ebookRoutes);
app.use('/api/resources', forumRoutes);
app.use('/api/resources', mentorshipRoutes);
app.use('/api/resources', resourceTestimonialRoutes);
app.use('/api/resources', videoLectureRoutes);
app.use('/api/resources', workshopRoutes);
